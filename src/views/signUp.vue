    ...
    <div class="sub-menu-profile">
        ...
        <a href="#" class="sub-menu-link">
          <i class="fa-solid fa-power-off"></i>
            ...
            <div class=" card col-8 offset-4" style="background-color: rgb(198, 149, 244);margin-top:30px;margin-bottom: 200px;max-width:400px;height:500px;border-radius:20px 20px;">
              <h3 class="my-3"><i class="mt-4 fa-solid fa-right-to-bracket"></i> SIGN UP</h3>
              
              <div class="my-3 form-group">
              <label class="fw-bolder">Name</label>
              <input @keyup.enter="SignUp" type="text" v-model="userData.name" placeholder="Enter Name" class="form-control"/>
              </div> 


              <div class="my-3 form-group">
              <label class="fw-bolder">Email</label>
              <input @keyup.enter="SignUp" type="text" v-model="userData.email" placeholder="Enter Email" class="form-control"/>
              </div> 

              <div class="my-3 form-group">
                <label class="fw-bolder">Password</label>
                <input @keyup.enter="SignUp" type="password" v-model="userData.password" placeholder="Enter Password" class="form-control"/>
                </div>
            <div class="my-3 modal-footer">
              <div class="my-3 modal-footer">
            <span class="already" @click="Login()"><u>Already Account!</u></span>
            </div><button class="my-3 btn btn-success" @click="SignUp()">SignUp</button>
            </div>
            </div>   
    </div>
</template>
